...
import { Card, CardContent, CardMedia, DialogContent, DialogTitle, Divider, Grid, IconButton, InputBase, Menu, Paper, Tooltip, Typography } from "@mui/material";
        ...
        >
            ...
            <Grid container spacing={1}>
                <Grid item xs={12} md={6}>
                    <Paper sx={{
                        backgroundImage:'url(https://y.qq.com/music/photo_new/T002R300x300M000003DFRzD192KKD_1.jpg)',
                    }}>
                ...
                <Grid item xs={12} md={6}>
                    <Paper sx={{
                        backgroundImage:'url(https://y.qq.com/music/photo_new/T002R300x300M000001BGzMs369FzU_1.jpg)',
                    }}>
                    <Card sx={{ display: 'flex',borderRadius:2 ,backgroundColor:'transparent',backdropFilter:'blur(3px)',width:'100%'}}>
                        <CardMedia sx={{pt:3,pb:3,pl:3,pr:1}}>
